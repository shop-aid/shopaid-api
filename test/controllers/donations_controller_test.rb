...
class DonationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create donation" do
    assert_difference('Donation.count') do
      post donations_url, params: { donation: { cause_id: @donation.cause_id, partner_id: @donation.partner_id, user_id: @donation.user_id } }
    end
  ...
  test "should update donation" do
    patch donation_url(@donation), params: { donation: { cause_id: @donation.cause_id, partner_id: @donation.partner_id, user_id: @donation.user_id } }
