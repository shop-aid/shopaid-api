...
class PartnersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create partner" do
    assert_difference('Partner.count') do
      post partners_url, params: { partner: { name: @partner.name, percentage: @partner.percentage } }
    end
  ...
  test "should update partner" do
    patch partner_url(@partner), params: { partner: { name: @partner.name, percentage: @partner.percentage } }
